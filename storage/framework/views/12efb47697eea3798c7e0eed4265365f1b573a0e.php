...
<link rel="stylesheet" href="<?php echo e(asset('assets/css/history.css')); ?>">
...
<div id="sidebar"> 
            ...
            <div id="sidebar-nav">   
              <ul>               
                ...
                <li><a href="toko"><i class="fa fa-home"></i> Store</a></li>
                <li></li>
    ...
    <section class="topupcard"> 
        <div class="wrapper rounded">
            ...
            <div class="row mt-2 pt-2">
                <div class="col-md-6" id="income">
                    <div class="d-flex justify-content-start align-items-center">
                        ...
                        <p class="text-white ml-4 money">RM 200</p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="d-flex justify-content-md-end align-items-center">
                        ...
                        <div class="text-white ml-4 money">RM 45</div>
                    </div>
                </div>
            </div>
            ...
            <div class="table-responsive mt-3">
                ...
                <tr>
                    <td scope="row">
                        <span class="fa fa-shopping-cart mr-3"></span> Pomfret
                    </td>
                    <td>
                    ...
                    <td class="d-flex justify-content-end align-items-center">
                        <span class="fa fa-long-arrow-up mr-1"></span> RM 8
                    </td>
                </tr>
                <tr>
                    <td scope="row">
                        <span class="fa fa-shopping-cart mr-3""></span> Squid
                    </td>
                    <td>
                        <span class="fa fa-credit-card"></span>
                    </td>
                    ...
                    <td class="d-flex justify-content-end align-items-center">
                        <span class="fa fa-long-arrow-up mr-1"></span> RM 30
                    </td>
                </tr>
                <tr>
                    <td scope="row">
                    ...
                    <td class="text-muted">11 Jul 2022, 2:00 PM</td>
                    <td class="d-flex justify-content-end align-items-center">
                        <span class="fa fa-long-arrow-down mr-1"></span> RM 100
                    </td>
                </tr>
                <tr>
                    <td scope="row">
                        <span class="fa fa-shopping-cart mr-3"></span> Octopus
                    </td>
                    <td>
                        <span class="fa fa-credit-card"></span>
                    </td>
                    ...
                    <td class="d-flex justify-content-end align-items-center">
                        <span class="fa fa-long-arrow-up mr-1"></span> RM 15
                    </td>
                </tr>
                <tr>
                    <td scope="row">
                        <span class="fa fa-shopping-cart mr-3"></span> Tilapia
                    </td>
                    <td>
                        <span class="fa fa-credit-card"></span>
                    </td>
                    ...
                    <td class="d-flex justify-content-end align-items-center">
                        <span class="fa fa-long-arrow-up mr-1"></span> RM 5
                    </td>
                </tr>
                <tr>
                    <td scope="row">
                        <span class="fa fa-shopping-cart mr-3""></span> Mackarel
                    </td>
                    <td>
                        <span class="fa fa-credit-card"></span>
                    </td>
                    ...
                    <td class="d-flex justify-content-end align-items-center">
                        <span class="fa fa-long-arrow-up mr-1"></span> RM 12
                    </td>
                </tr>
                <tr>
                    <td scope="row">
                        <span class="fa fa-shopping-cart mr-3""></span>  Sea cucumber
                    </td>
                    <td>
                        <span class="fa fa-credit-card"></span>
                    </td>
                    ...
                    <td class="d-flex justify-content-end align-items-center">
                        <span class="fa fa-long-arrow-up mr-1"></span> RM 10
                    </td>
                </tr>
                </tbody>
                </table>
...
<?php echo $__env->make('layouts.profile-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\acer\Documents\SI4404_Kelompok2_Pescador\resources\views/historytr.blade.php ENDPATH**/ ?>