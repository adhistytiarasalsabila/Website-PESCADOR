        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <h3 class="font-weight-semi-bold mb-4">RM 10</h3>
                    <p class="mb-4">Red Snapper from the fisherman's catch.</p>
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        ...
                        <a class="" href="payment"><button class="btn btn-primary px-3 ml-3" ><i class="fa fa-buy mr-1" ></i> Buy Now</button></a>
                    </div>
                ...
                <div class="bg-light p-30">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="tab-pane-1">
                            ...
                            <p>Sea catch.</p>
                            <p>Guaranteed fresh and newly caught.</p>
                        </div>
                        <div class="tab-pane fade" id="tab-pane-2">
                            <h4 class="mb-3">Additional Information</h4>
                            <p>Address Pasir putih St No.37 NO HP.011377263652.</p>
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="media mb-4">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p>Wow, the fish is still very fresh, perfect for cooking sweet and sour. Great job, the seller is honest and the product is as described.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\acer\Documents\SI4404_Kelompok2_Pescador\resources\views/detail.blade.php ENDPATH**/ ?>