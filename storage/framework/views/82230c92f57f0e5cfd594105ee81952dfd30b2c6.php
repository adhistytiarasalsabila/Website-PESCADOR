...
<link rel="stylesheet" href="<?php echo e(asset('assets/css/toko.css')); ?>">
<section>
<div id="sidebar"> 
  ...
  <div class="container py-5 ">
    <div class=" row">
      ...
      <section class="lamanke5" id="lamanke5">
        ...
        <div class="textll1">
            <h1>Register You're Store!</h1>
            <div class="mt-4" >
            <button class="subt btn btn-success rounded-pill mb-3" type="submit" ><a class="nav-link" href="login">Store Register</a></button>
            </div>
...
<?php echo $__env->make('layouts.profile-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\acer\Documents\SI4404_Kelompok2_Pescador\resources\views/toko.blade.php ENDPATH**/ ?>